...
{
    public class SincePreviousPostTriggerParametersToken : ITokenizedTemplatePrimitiveToken
    {
        ...
        public SincePreviousPostTriggerParametersToken(string name, string description,
