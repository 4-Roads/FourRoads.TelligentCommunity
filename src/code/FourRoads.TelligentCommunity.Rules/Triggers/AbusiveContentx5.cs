...
namespace FourRoads.TelligentCommunity.Rules.Triggers
{
    public class AbusiveContentx5 : IRuleTrigger, ITranslatablePlugin, ISingletonPlugin, ICategorizedPlugin
    {
        ...
        private readonly Guid _triggerid = new Guid("{036F282B-105A-43B7-9C8B-DD19D5F8EE1D}");
        ...
        public Translation[] DefaultTranslations
        {
            get
            {
                ...
                defaultTranslation[0].Set("RuleTriggerName", "a post is flagged as abusive 5 times - 4 roads");
