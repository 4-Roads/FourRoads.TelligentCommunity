...
namespace FourRoads.TelligentCommunity.SocialProfileControls.Controls
{
    public class FacebookProfileControlPropertyTemplate : SocialProfileFieldControlPropertyTemplate, IPropertyTemplate, ITranslatablePlugin
    {
        ...
        public string Name => "4 Roads - Facebook - Field Control Property Template";

        public string Description => "Controls the input of facebook details into the users profile";
